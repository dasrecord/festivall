  ...
  archive: [
    {
      ...
      performers: [
        ...
        { name: 'MoriMori', role: 'DJ', note: 'Hiphop' },
        { name: 'Ryan Burke', role: 'Performer' },
        { name: 'Paulina Gemini', role: 'DJ', note: 'House' },
        { name: 'Okams Racer w/ Kofi', role: 'Rapper' },
      ],
      speakers: [
    ...
    },
    {
      ...
      performers: [
        { name: 'Paulina Gemini', role: 'DJ', note: 'House' },
        { name: 'STAR x DUST', role: 'DJ', note: 'House' },
        { name: 'Kris Jones', role: 'DJ', note: 'House' },
      ],
      speakers: [
