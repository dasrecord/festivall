...
const reunion_auth = getAuth(reunion_app)
...
export { festivall_auth, reunion_auth, reunion_db, reunion_storage, festivall_db, reunion_analytics, festivall_analytics }
